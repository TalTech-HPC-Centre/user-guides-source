...
|---------|------------|------------------|-----------|
| CPU     | CPU*hour   | 0.002 EUR        | 0.002 EUR |
| Memory  | RAM*hour   | 0.001 EUR        | 0.001 EUR |
| Storage | TB*hour    | 0.03 EUR         | 0.025 EUR |

### TalTech cluster

| What                | Unit           | Standard price | EU project price  |
|---------------------|----------------|------------------|-----------|
| CPUcore & < 6 GB RAM| CPUcore*hour   | 0.008 EUR        | 0.007 EUR |
| CPUcore & > 6 GB RAM| 6 GB RAM*hour  | 0.008 EUR        | 0.007 EUR |
| GPU                 | GPU*hour       | 0.62 EUR         | 0.54 EUR  |
| Storage             | 1 TB*hour      | 0.007 EUR        | 0.006 EUR |
...
| What                  | Unit       | Standard price | EU project price |
|-----------------------|------------|----------------|------------------|
| Administrator service | hour       | 56 EUR         | 49 EUR           |
